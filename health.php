  ...
  <div class="intro container mb-100">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-nmonitor.svg">
      </div>
    </div>
  </div>
	<!-- <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col mt-100">
          <img src="images/health/monitor-nmonitor.png" width="100%">
        </div>
      </div>
    </div>
  </section> -->
...
<!-- Feature 25 -->
<section id="nCommand" class="detalhamento feature_25">
  <div class="container-flex header-do-detalhamento">
    <div class="row logo-do-produto" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
      <div class="espaco-branco-cima"></div>
      <img class="logo" src="images/health/health-produtos/logo-ncommand.svg" alt="logo do n-monitor">
    </div>
    <div style="margin:-2px auto 100px; width: 100%; overflow-x:hidden;">
      <img src="images/img-bottom-curve.svg" style="width:110%; margin-left:-5%;">
    </div>
  ...
  <div class="intro container mb-100">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-ncommand.svg">
      </div>
    </div>
  </div>
	<!-- <div class="container px-xl-0">
  ...
  <div style="width:100vw;">
    <img src="images/health/DSC08717.jpg" style="width:100%;">
  </div>
</section>


<!-- nReport (Feature 13) -->
<section id="nReport" class="detalhamento feature_13">
  <div class="container-flex header-do-detalhamento">
    <div class="row logo-do-produto" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
      <div class="espaco-branco-cima"></div>
      <img class="logo" src="images/health/health-produtos/logo-nreport.svg" alt="logo do n-monitor">
    </div>
    <div style="margin:-2px auto 100px; width: 100%; overflow-x:hidden;">
      <img src="images/img-bottom-curve.svg" style="width:110%; margin-left:-5%;">
    </div>
  ...
  <div class="intro container mb-100">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-nreport.svg">
      </div>
    </div>
  </div>
  <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden;">
  ...
  <div style="background:white;" class="pb-100">
  	<div class="container px-xl-0">
...
<!-- nSensor (Feature 10) -->
<section id="nSensor" class="detalhamento feature_10">
  <div class="container-flex header-do-detalhamento">
    <div class="row logo-do-produto" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
      <div class="espaco-branco-cima"></div>
      <img class="logo" src="images/health/health-produtos/logo-nsensor.svg" alt="logo do n-monitor">
    </div>
    <div style="margin:-2px auto 100px; width: 100%; overflow-x:hidden;">
      <img src="images/img-bottom-curve.svg" style="width:110%; margin-left:-5%;">
    </div>
  ...
  <div class="intro container mb-100">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-nsensor.svg">
      </div>
    </div>
  </div>
  <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden;">
...
<!-- nAgenda -->
<section id="nAgenda" class="detalhamento feature_17">
  <div class="container-flex header-do-detalhamento">
    <div class="row logo-do-produto" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
      <div class="espaco-branco-cima"></div>
      <img class="logo" src="images/health/health-produtos/logo-nagenda.svg" alt="logo do n-monitor">
    </div>
    <div style="margin:-2px auto 100px; width: 100%; overflow-x:hidden;">
      <img src="images/img-bottom-curve.svg" style="width:110%; margin-left:-5%;">
    </div>
  ...
  <div class="intro container mb-100">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-nagenda.svg">
      </div>
    </div>
  </div>
  <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden;">
  ...
  <div class="bg-light pt-60 pb-100">
    <div class="container px-xl-0">
  		<div class="row">
...
<section id="nEcho" class="detalhamento feature_16">
  ...
  <div class="intro container mb-100">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-necho.svg">
      </div>
    </div>
  </div>
  <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden;">
...
<!-- nVoice -->
<section id="nVoice" class="detalhamento feature_25">
  <div class="container-flex header-do-detalhamento">
    <div class="row logo-do-produto" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
      <div class="espaco-branco-cima"></div>
      <img class="logo" src="images/health/health-produtos/logo-iara.svg" alt="logo do n-monitor">
    </div>
    <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden;">
      <img src="images/img-bottom-curve.svg" style="width:110%; margin-left:-5%;">
    </div>
  ...
  <div class="intro container mb-10">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-nspeech.svg">
      </div>
    </div>
  </div>
  <div class="bg-dark">
    <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden; position: absolute; z-index:1;">
      <img src="images/img-bottom-curve-bodycolor.svg" style="width:110%; margin-left:-5%;">
    </div>
    ...
    <!-- <div class="container px-xl-0 color-white" style="background: url('images/health/ness-health-nvoice.jpg'); background-size:cover;">
  		<div class="row justify-content-between">
  			<div class="col-xl-8 col-lg-9 col-md-10 pt-105 pb-70 left_side">
...
<!-- nDoctor (Feature 15) -->
<section id="nDoctor" class="detalhamento feature_15">
  <div class="container-flex header-do-detalhamento">
    <div class="row logo-do-produto" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
      <div class="espaco-branco-cima"></div>
      <img class="logo" src="images/health/health-produtos/logo-ndoctor.svg" alt="logo do n-monitor">
    </div>
    <div style="margin:-2px auto 0; width: 100%; overflow-x:hidden;">
      <img src="images/img-bottom-curve.svg" style="width:110%; margin-left:-5%;">
    </div>
  ...
  <div class="intro container mb-10">
    <div class="row d-flex align-items-center">
      ...
      <div class="imagem col-md-7">
        <img src="images/health/isohero/isohero-ndoctor.svg">
      </div>
    </div>
  </div>
	<!-- <div class="container px-xl-0">
