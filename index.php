...
<body class="slides animated">
  ...
  <!-- SOBRE -->
  <section id="sobre" class="feature_20 bg-light" data-aos-duration="600" data-aos="fade" data-aos-delay="0">
  ...
  <section id="verticais" class="feature_47 pt-105 pb-70 color-white">
    <div class="container px-xl-0">
      <div class="row justify-content-left text-left text-md-left">
        <div class="col-xl-12 col-lg-12 mb-50" data-aos-duration="700" data-aos="fade" data-aos-delay="0">
          <h3 class="mb-20 text-left destaque-no-fundo-escuro" data-aos-duration="600" data-aos="fade-down" data-aos-delay="0">​​Verticais</h3>
    ...
    <div class="container px-xl-0" style="width: 90%; max-width: 90%;">
      <div class="row justify-content-center text-center text-md-left">

        <div class="mb-30 col-lg-2 col-md-2 col-sm-2 d-flex align-items-stretch" data-aos-duration="600" data-aos="fade-down" data-aos-delay="0">
          <div class="pt-35 pb-45 pl-40 pr-30 radius10 block">
            <img src="images/health/logo-ness-health.svg" width="200px" alt="">
          </div>
        </div>
        
        <div class="mb-30 col-lg-2 col-md-2 col-sm-2 d-flex align-items-stretch" data-aos-duration="600" data-aos="fade-down" data-aos-delay="100">
          <div class="pt-35 pb-45 pl-40 pr-30 radius10 block">
            <img src="images/health/logo-ness-health.svg" width="200px" alt="">
          </div>
        </div>
        
        <div class="mb-30 col-lg-2 col-md-2 col-sm-2 d-flex align-items-stretch" data-aos-duration="600" data-aos="fade-down" data-aos-delay="200">
          <div class="pt-35 pb-45 pl-40 pr-30 radius10 block">
            <img src="images/health/logo-ness-health.svg" width="200px" alt="">
          </div>
        </div>
        
        <div class="mb-30 col-lg-2 col-md-2 col-sm-2 d-flex align-items-stretch" data-aos-duration="600" data-aos="fade-down" data-aos-delay="300">
          <div class="pt-35 pb-45 pl-40 pr-30 radius10 block">
            <img src="images/health/logo-ness-health.svg" width="200px" alt="">
          </div>
        </div>
        
        <div class="mb-30 col-lg-2 col-md-2 col-sm-2 d-flex align-items-stretch" data-aos-duration="600" data-aos="fade-down" data-aos-delay="400">
          <div class="pt-35 pb-45 pl-40 pr-30 radius10 block">
            <img src="images/health/logo-ness-health.svg" width="200px" alt="">
          </div>
        </div>
  ...
  <section id="clientes" class="content_31 bg-dark-2 pt-100 pb-70 text-center">
    <div class="container px-xl-0 text-center">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-3 col-md-5 col-sm-6" data-aos-duration="700" data-aos="fade-down" data-aos-delay="0">
        ...
        <div class="col-lg-3 col-md-5 col-sm-6" data-aos-duration="700" data-aos="fade-down" data-aos-delay="1250">
          <div class="mx-auto mb-30 mw-270 h-160 d-flex justify-content-center align-items-center radius6 block">
            <img src="images/home/clientes/saude-10.png" alt="" />
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Vagas -->
  <section id="vagas" class="feature_20 bg-light" data-aos-duration="600" data-aos="fade" data-aos-delay="0">
    <div class="container px-xl-0">
      <div class="row justify-content-between align-items-stretch">
  ...
  <section id="contato" class="contact_4 pt-100 pb-100">
    <div class="container px-xl-0">
      <div class="row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 color-white">
          <h2 class="mb-25 small destaque-no-fundo-escuro" data-aos-duration="700" data-aos="fade-down" data-aos-delay="0">Let’s Keep in Touch</h2>
          <div class="pb-10 f-22 text-adaptive" data-aos-duration="700" data-aos="fade-down" data-aos-delay="350">
            We have created a new product <br />
            that will help designers, developers <br />
            and companies create websites for <br />
            their startups quickly and easily.
          </div>

          <div data-aos-duration="700" data-aos="fade-down" data-aos-delay="700">
            <a href="tel:+15555055050" class="mt-45 link color-white d-flex align-items-baseline">
              <i class="w-30 fas fa-phone flex-shrink-0 fa-flip-horizontal f-14 text-right"></i>
              <div>+1 555 505 5050</div>
            </a>

            <a href="mailto:info@designmodo.com" class="mt-45 link color-white d-flex align-items-baseline">
        ...
        <div class="col-xl-5 col-lg-6 col-md-8 mt-50 mt-lg-0" data-aos-duration="700" data-aos="fade-down" data-aos-delay="1050">
          <form action="form-handler.php" method="post" class="bg-light px-50 pt-55 pb-55 radius10">
            <div class="row">
              <div class="col-sm-7">
                <div class="mb-10 f-14 semibold text-uppercase sp-20">Your Name</div>
              ...
              <div class="col-sm-5">
                <div class="mb-10 f-14 semibold text-uppercase sp-20">Budget</div>
                <select name="budget" class="mb-35 input w-full border-gray focus-action-1 color-heading placeholder-heading" required>
            ...
            <div class="mb-10 f-14 semibold text-uppercase sp-20">Your email</div>
            ...
            <div class="mb-10 f-14 semibold text-uppercase sp-20">Your Message</div>
            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-sm-7">
                <input type="checkbox" name="send_copy" class="d-none border-gray focus-action-1" id="contact_4_checkbox" checked />
                <label for="contact_4_checkbox" class="color-heading">
                  Send me a copy
                </label>
              </div>
              <div class="col-xl-5 col-sm-5">
                <button class="mt-20 mt-sm-0 btn action-1 w-full">Send</button>
              </div>
            </div>
          </form>
        </div>
